...
#cur = ['btcusd', 'ethusd', 'ustusd', 'xrpusd', 'ltcusd']
...
print('long_average = ' + str(long_total_percent / float(long_trades)))
...
print('short_average = ' + str(short_total_percent / float(short_trades)))
'''
